...
Code coverage report is provided via Istanbul and highlights which parts of the app are not covered. This report can be viewed in `code-coverage-report/html/index.html` <strong>after</strong> running `npm run test`:
